...
/// Paleta del proyecto: verde de cancha sobre carbón mate (estética EA FC).
class AppColors {
  AppColors._();
  ...
  static const borde = Color(0x1AFFFFFF); // bordes sutiles (blanco 10%)

  static const texto = Color(0xFFF4F7F9); // texto principal
  static const gris = Color(0xFF8B98A2); // texto secundario / iconos
}
